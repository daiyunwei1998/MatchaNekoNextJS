...
export default function page() {
  return (
    ...
    columnsCount={3} gutter="10px">
        {images.map((image, i) => (                 
                        <Badge.Ribbon key = {i} text="Hippies">
                        <AntdImage
                            key={i}
                            src={image}
